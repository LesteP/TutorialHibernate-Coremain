...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.tutorial.service.impl.PasswordTokenManager#generateRecoveryToken(com.tutorial.model.User)
     */
    @Override
    ...
    /**
     * @see com.tutorial.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.tutorial.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.tutorial.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
